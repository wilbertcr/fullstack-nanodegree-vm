...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Component2 = __webpack_require__(247);

	var _Component3 = _interopRequireDefault(_Component2);

	var _GoogleAuth = __webpack_require__(251);
	...
	var _ItemsContainer = __webpack_require__(271);
	...
	var CatalogApp = function (_Component) {
	    ...
	    function CatalogApp(props) {
	        ...
	        _this.state = {
	            categories: [],
	            items: [],
	            login_status: _this.STATUS.LoggedOut,
	            categoryId: 0
	        };
	        return _this;
	    }
	    ...
	    (0, _createClass3.default)(CatalogApp, [{
	        key: 'onSessionChange',
	        value: function onSessionChange(state) {
	        ...
	        value: function displayCategory(category) {
	            this.setState((0, _extends3.default)({}, this.state, { items: category.items, categoryId: category.id }));
	        }
	    }, {
	        key: 'deleteCategory',
	        ...
	        value: function editCategory(category) {
	            ...
	            this.setState({ data: (0, _extends3.default)({}, this.state.categories.slice(0, index), {
	        ...
	        value: function render() {
	            return _react2.default.createElement('div', { className: 'root_container ui grid' }, _react2.default.createElement('div', { className: 'sixteen column inverted row' }, _react2.default.createElement(_GoogleAuth2.default, { onSessionChange: this.onSessionChange })), _react2.default.createElement('div', { className: 'left floated three wide column', style: { marginTop: '50px' } }, _react2.default.createElement(_Sidebar2.default, { categories: this.state.categories,
	                login_status: this.state.login_status,
	                displayCategory: this.displayCategory,
	                deleteCategory: this.deleteCategory,
	                addCategory: this.addCategory,
	                editCategory: this.editCategory })), _react2.default.createElement('div', { className: 'left floated left aligned thirteen wide column', style: { marginTop: '55px' } }, _react2.default.createElement(_ItemsContainer2.default, { items: this.state.items,
	                login_status: this.state.login_status })));
	        }
	    }]);
	    return CatalogApp;
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(9)(Function.call, __webpack_require__(79).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getOwnPropertyNames = __webpack_require__(248);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apiCall = __webpack_require__(252);
	...
	var GoogleAuth2 = function (_Component) {
	    (0, _inherits3.default)(GoogleAuth2, _Component);

	    function GoogleAuth2(props) {
	        (0, _classCallCheck3.default)(this, GoogleAuth2);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(GoogleAuth2).call(this, props));
	        ...
	        _this.state = {
	            ...
	            loginStatus: _this.STATUS.LoggedOut,
	            userId: 0,
	            userName: "",
	            userEmail: "",
	            userPicture: null
	    ...
	    (0, _createClass3.default)(GoogleAuth2, [{
	        key: 'onSessionChange',
	        value: function onSessionChange(state) {
	            if (state) {
	                ...
	                this.setState((0, _extends3.default)({}, this.state, { loginStatus: this.STATUS.LoggedOut }));
	                this.props.onSessionChange(this.state.loginStatus);
	            }
	        }
	    }, {
	        ...
	        key: 'signInFailure',
	        value: function signInFailure(reason) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('div', { className: 'ui blue top fixed inverted menu',
	                ...
	                style: { display: this.state.loginStatus.value ? 'none' : 'inline-block' } }, _react2.default.createElement('i', { className: 'google plus icon' }), 'Sign in.'), _react2.default.createElement('div', { className: 'ui dropdown',
	                style: { display: this.state.loginStatus.value ? 'inline-block' : 'none' } }, _react2.default.createElement('img', { className: 'ui avatar image dropdown',
	                src: this.state.userPicture }), _react2.default.createElement('div', { className: 'ui inverted menu' }, _react2.default.createElement('div', { className: 'ui item' }, _react2.default.createElement('div', { className: 'ui red card' }, _react2.default.createElement('div', { className: 'image' }, _react2.default.createElement('img', { src: this.state.userPicture })), _react2.default.createElement('div', { className: 'content' }, _react2.default.createElement('div', { className: 'header' }, this.state.userName), _react2.default.createElement('div', { className: 'meta' }, this.state.userEmail)), _react2.default.createElement('div', { className: 'extra content' }, _react2.default.createElement('div', { className: 'ui one white button' }, _react2.default.createElement('div', { id: 'signOutButton',
	                className: 'ui google plus button',
	                onClick: this.signOut,
	                style: { display: this.state.loginStatus.value ? 'inline-block' : 'none' } }, _react2.default.createElement('i', { className: 'google plus icon' }), 'Sign out.'))))))))));
	        }
	    }]);
	    return GoogleAuth2;
	}(_Component3.default);

	exports.default = GoogleAuth2;
	...
	var Sidebar = function (_Component) {
	    ...
	    (0, _createClass3.default)(Sidebar, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('div', { className: 'ui left vertical menu' }, this.props.categories.map(function (category, index) {
	                return _react2.default.createElement(_Category2.default, { key: category.id,
	                    index: index,
	                    category: category,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _riek = __webpack_require__(255);

	var _Component2 = __webpack_require__(247);

	var _Component3 = _interopRequireDefault(_Component2);

	var _ModalPage = __webpack_require__(261);
	...
	var Category = function (_Component) {
	    ...
	    function Category(props) {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Category).call(this, props));
	    ...
	    (0, _createClass3.default)(Category, [{
	        ...
	        value: function editCategory(category) {
	            this.props.editCategory(category);
	            this.setState((0, _extends3.default)({}, this.state, { edit_modal_visible: !this.state.edit_modal_visible }));
	        }
	    }, {
	        key: 'deleteCategory',
	        ...
	        key: 'displayCategory',
	        value: function displayCategory() {
	        ...
	        value: function displayDeleteModal() {}
	    }, {
	        key: 'displayEditModal',
	        value: function displayEditModal() {
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('a', { className: 'blue left item' }, _react2.default.createElement('i', { className: 'edit icon',
	                style: { display: this.props.login_status.value ? 'inline-block' : 'none' },
	                onClick: this.displayEditModal }), _react2.default.createElement('i', { className: 'erase icon',
	                style: { display: this.props.login_status.value ? 'inline-block' : 'none' },
	                onClick: this.displayDeleteModal }), _react2.default.createElement('div', { className: 'ui blue circular label' }, this.props.category.items.length), _react2.default.createElement('div', { className: 'ui text',
	                onClick: this.displayCategory }, this.props.category.name), _react2.default.createElement(_ModalPage2.default, { category: this.props.category,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RIEBase2 = __webpack_require__(257);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalPage = function (_Component) {
	    ...
	    function ModalPage(props) {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ModalPage).call(this, props));
	    ...
	    (0, _createClass3.default)(ModalPage, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('div', { className: modal_classes, onClick: this.handleClick }, _react2.default.createElement(_Modal2.default, { category: this.props.category,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EditCategoryForm = __webpack_require__(263);
	...
	var Modal = function (_Component) {
	    ...
	    (0, _createClass3.default)(Modal, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('div', { className: modalClasses,
	                onClick: this.handleClick }, _react2.default.createElement('div', { className: 'header' }, 'Edit Category'), _react2.default.createElement('div', { className: 'content' }, _react2.default.createElement(_EditCategoryForm2.default, { category: this.props.category,
	                editCategory: this.editCategory })));
	        }
	    }]);
	    return Modal;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bleach = __webpack_require__(264);

	var EditCategoryForm = function (_Component) {
	    (0, _inherits3.default)(EditCategoryForm, _Component);

	    function EditCategoryForm(props) {
	        (0, _classCallCheck3.default)(this, EditCategoryForm);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(EditCategoryForm).call(this, props));

	        _this.state = { category: _this.props.category,
	            validated: true };
	        return _this;
	    }
	    ...
	    (0, _createClass3.default)(EditCategoryForm, [{
	        key: 'updateName',
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('div', { className: formClasses }, _react2.default.createElement('div', { className: 'one field' }, _react2.default.createElement('div', { className: 'required field' }, _react2.default.createElement('label', null, 'Category'), _react2.default.createElement('input', { type: 'text',
	                ref: function ref(_ref) {
	                    return _this2.textInput = _ref;
	                },
	                value: this.state.category.name,
	                onChange: this.updateName,
	                onKeyPress: this.handleKey })), _react2.default.createElement('div', { className: 'ui error message' }, _react2.default.createElement('div', { className: 'header' }, 'Empty name'), _react2.default.createElement('p', null, 'Category must have a nonempty name.'))), _react2.default.createElement('div', { className: 'ui submit button', onClick: this.editCategory }, 'Submit'));
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs = __webpack_require__(266),
	    he = __webpack_require__(267);
	      ...
	      for (var i in filters) {
	        if (typeof filters[i] == 'function') {
	          ...
	          for (var j in available) {
	            if (file == available[j]) {
	              html = __webpack_require__(269)("./" + file)(html);
	            }
	          }
	        }
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(module, global) {/*! http://mths.be/he v0.4.1 by @mathias | MIT license */
	;(function(root) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemsContainer = function (_Component) {
	    ...
	    (0, _createClass3.default)(ItemsContainer, [{
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { className: 'ui cards container' }, this.props.items.map(function (item, index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CatalogApp = function (_Component) {
	    ...
	    (0, _createClass3.default)(CatalogApp, [{
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { className: 'card' }, _react2.default.createElement('div', { className: 'content' }, _react2.default.createElement('img', { className: 'ui medium circular bordered image', src: this.props.item.picture }), _react2.default.createElement('div', { className: 'header' }, 'Name: ', this.props.item.name), _react2.default.createElement('div', { className: 'meta' }, 'Price: $', this.props.item.price), _react2.default.createElement('div', { className: 'content' }, 'Description: ', this.props.item.description)), _react2.default.createElement('div', { className: 'extra content',
	                style: { display: this.props.login_status.value ? 'inline-block' : 'none' } }, _react2.default.createElement('div', { className: 'ui two butons' }, _react2.default.createElement('div', { className: 'ui basic blue button' }, 'Edit'), _react2.default.createElement('div', { className: 'ui basic red button' }, 'Delete'))));
	        }
	    }]);
	    return CatalogApp;
	}(_Component3.default);
